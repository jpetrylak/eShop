...
public class Order : EntityBase<long>
{
    ...
    public void AddPosition(Product product, int amount)
    {
        ...
        AddDomainEvent(new OrderPositionAddedDomainEvent(Guid, product.Id, product.Name, product.Price, amount));
    }
    ...
    public void RemovePosition(long productId)
    {
        ...
        AddDomainEvent(new OrderPositionRemovedDomainEvent(Guid, productId));
    }
    ...
    public void MarkAsPaid(DateTime payDateTime)
    {
        ...
        AddDomainEvent(new OrderPaidDomainEvent(Guid, payDateTime));
    }
    ...
    public void MarkAsShipped(DateTime shippingDateTime)
    {
        ...
        AddDomainEvent(new OrderShippedDomainEvent(Guid, shippingDateTime));
    }
