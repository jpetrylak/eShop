    ...
    where TDomainEvent : IDomainEvent
{
    ...
    private readonly IDomainEventToIntegrationEventMapper _eventsFactory;
    ...
    public BusPublisherDomainEventHandlerDecorator(
        ...
        IDomainEventToIntegrationEventMapper eventsFactory)
    {
        _logger = logger;
    ...
    {
        IIntegrationEvent integrationEvent = _eventsFactory.Map(@event);
