...
public class AddPositionTests
{
    ...
    public void GivenPaidOrder_ThrowsException()
    {
        ...
        // act & assert
        Should.Throw<BusinessRuleException>(() => order.AddPosition(product, 1))
    ...
    public void GivenInvalidPosition_ThrowsException(long productId, string productName, string productPriceStr, int amount)
    {
        ...
        // act & assert
        Should.Throw<BusinessRuleException>(() => order.AddPosition(product, amount))
            .Code.ShouldBe(nameof(CorrectPositionRule));
    }
    ...
    public void GivenDuplicatedProductPosition_ThrowsException()
    {
        ...
        Should.Throw<BusinessRuleException>(() => order.AddPosition(product2, 1))
            .Code.ShouldBe(nameof(UniqueProductsRule));
    }
